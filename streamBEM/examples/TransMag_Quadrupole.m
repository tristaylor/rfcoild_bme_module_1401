...
[coil.listNode,coil.listTriangle,coil.tri] = importMeshWavefront(fullfile('.','data','26x95_R165_H250_2.obj'));
coil.center = [0 0 0];
coil.reduction = 1;
...
degreeMax = 5;
orderMax = 5;
rhoReference = 0.04/2; % radius of reference
...
coil.coil_radius = 0.33/2;
coil.coil_length = 0.25;
